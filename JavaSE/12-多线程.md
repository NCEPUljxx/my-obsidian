...
![](../data/JavaSE/12-多线程/01_简单了解多线程.png))

### 1.2并发和并行【理解】

+ 并行：在同一时刻，有多个指令在多个CPU上同时执行。

  ![](../data/JavaSE/12-多线程/02_并行.png))

+ 并发：在同一时刻，有多个指令在单个CPU上交替执行。

  ![](../data/JavaSE/12-多线程/03_并发.png))
...
- 线程：是进程中的单个顺序控制流，是一条执行路径
  ...
  ​	![](../data/JavaSE/12-多线程/04_多线程示例.png))
...
- 线程调度
  ...
  - 随机性
    ...
    ![](../data/JavaSE/12-多线程/05_多线程示例图.png))
...
+ 阻塞队列继承结构
  ...
  ![](../data/JavaSE/12-多线程/06_阻塞队列继承结构.png))
...
![](../data/JavaSE/12-多线程/1591163781941.png))
...
![](../data/JavaSE/12-多线程/1591165506516.png))
...
![](../data/JavaSE/12-多线程/1591168965857.png))
...
![](../data/JavaSE/12-多线程/1591169254280.png))

### 3.4 并发工具类-ConcurrentHashMap1.8原理

![](../data/JavaSE/12-多线程/1591169338256.png))
