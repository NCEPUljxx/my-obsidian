...
![](file:///D:/Java/data/JavaSE/12-多线程/01_简单了解多线程.png))

### 1.2并发和并行【理解】

+ 并行：在同一时刻，有多个指令在多个CPU上同时执行。

  ![](file:///D:/Java/data/JavaSE/12-多线程/02_并行.png))

+ 并发：在同一时刻，有多个指令在单个CPU上交替执行。

  ![](file:///D:/Java/data/JavaSE/12-多线程/03_并发.png))
...
- 线程：是进程中的单个顺序控制流，是一条执行路径
  ...
  ​	![](file:///D:/Java/data/JavaSE/12-多线程/04_多线程示例.png))
...
- 线程调度
  ...
  - 随机性
    ...
    ![](file:///D:/Java/data/JavaSE/12-多线程/05_多线程示例图.png))
...
- 同步代码块格式：
  ...
  ```java
  synchronized 加锁的粒度影响性能，[[10-集合框架]] 中有更多线程安全集合的讨论。(任意对象) { 
  	多条语句操作共享数据的代码 
  }
  ```
...
+ 阻塞队列继承结构
  ...
  ![](file:///D:/Java/data/JavaSE/12-多线程/06_阻塞队列继承结构.png))
...
## 1. 线程池复用线程资源，多线程下载在 [[13-网络编程]] 中有实际应用。
...
### 3.2 并发工具类-ConcurrentHashMap 是线程安全的 HashMap，[[10-集合框架]] 中讲了 HashMap 的基础用法。基本使用
