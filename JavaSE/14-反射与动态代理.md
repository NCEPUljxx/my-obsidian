# 反射与动态代理基于反射实现，常用于框架中（如 Spring AOP 的切面代理基于此实现——见

[[JavaWeb/06-SpringBoot事务与AOP|JavaWeb AOP]]
。 框架中大量使用反射——
[[JavaWeb/06-SpringBoot事务与AOP|JavaWeb AOP]]
的切面代理就是基于此实现。 AOP），与
[[05-面向对象编程]]
...
> 📎 **相关笔记**：[[05-面向对象编程]] · [[JavaSE/09-常用API/09-Math与System]] · [[JavaWeb/02-数据库与持久层]] · [[JavaWeb/06-SpringBoot事务与AOP]] · [[JavaWeb/07-SpringBoot原理]] · [[JavaWeb/02-数据库与持久层]] · [[JavaWeb/06-SpringBoot事务与AOP]] · [[JavaWeb/07-SpringBoot原理]]
