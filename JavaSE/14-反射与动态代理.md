# 反射与动态代理基于反射实现，常用于框架中（如 Spring AOP 的切面代理基于此实现——见 [[JavaWeb/06-SpringBoot事务与AOP|JavaWeb AOP]]。 框架中大量使用反射——[[JavaWeb/06-SpringBoot事务与AOP|JavaWeb AOP]] 的切面代理就是基于此实现。 AOP），与 [[05-面向对象编程]] 的接口密切相关。
...
③通过类名反射得到Class 对象在 [[05-面向对象编程]] 的类加载过程时生成，每个类都有唯一的 Class 对象。
...
> 📎 **相关笔记**：[[05-面向对象编程]] · [[09-常用API]] · [[JavaWeb/02-数据库与持久层]] · [[JavaWeb/06-SpringBoot事务与AOP]] · [[JavaWeb/07-SpringBoot原理]] · [[JavaWeb/02-数据库与持久层]] · [[JavaWeb/06-SpringBoot事务与AOP]] · [[JavaWeb/07-SpringBoot原理]]
