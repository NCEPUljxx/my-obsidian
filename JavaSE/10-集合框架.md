...
- Map集合的基本使用
  ...
  public class MapDemo01 {
      public static void main(String[] args) {
          //创建集合对象
          Map<String,String> map = new HashMap 是非线程安全的，[[JavaSE/12-多线程/12-线程基础]] 中有 ConcurrentHashMap 作为线程安全替代。<String,String>();
...
## 3.TreeMap 底层是红黑树，其排序依赖

[[05-面向对象编程]]
中的 Comparable/Comparator 接口。集合
...
## 2.Stream 的 filter/map/reduce 操作配合

[[JavaSE/09-常用API/09-Math与System]]
中的 Lambda 表达式使用。
...
- Stream流的思想
  ...
  ![](file:///D:/Java/data/JavaSE/10-集合框架/01_Stream流思想.png))
...
> 📎 **相关笔记**：[[08-ArrayList与学生管理系统]] · [[05-面向对象编程]] · [[JavaSE/09-常用API/09-Math与System]] · [[JavaSE/11-IO流/11-异常与File]] · [[JavaSE/12-多线程/12-线程基础]] · [[JavaWeb/02-数据库与持久层]] · [[JavaWeb/02-数据库与持久层]]
