...
游戏运行之后，就是这样的界面。
                                         ![创建项目1](../data/JavaSE/06-面向对象综合练习/最终效果1.png)) 

刚开始打开，是登录页面，因为是第一次运行，需要注册。点击注册就会跳转到注册页面

​                                       ![创建项目1](../data/JavaSE/06-面向对象综合练习/最终效果2.png))

在注册页面我们可以注册账号，用户名如果已存在则会注册失败。

​                                       ![创建项目1](../data/JavaSE/06-面向对象综合练习/最终效果3.png))
...
![初始界面](../data/JavaSE/06-面向对象综合练习/初始界面.png))
...
![初始界面](../data/JavaSE/06-面向对象综合练习/菜单.png))

### 7.1菜单的组成

![初始界面](../data/JavaSE/06-面向对象综合练习/菜单2.png))
...
![移动](../data/JavaSE/06-面向对象综合练习/移动.png))
...
## 3. 查看完整图片的功能
 ...
 ![查看完整图片](../data/JavaSE/06-面向对象综合练习/查看完整图片.png))
