...
![](file:///D:/Java/data/JavaSE/11-IO流/异常体系.png)
...
![](file:///D:/Java/data/JavaSE/11-IO流/简单的异常查看.bmp)
...
* **运行时期异常**:runtime异常。在运行时期,检查异常.在编译时期,运行异常不会编译器检测(不报错)。(如数学异常)
    ...
    ![](file:///D:/Java/data/JavaSE/11-IO流/异常的分类.png)
...
上述程序执行过程图解：
 ...
 ![](file:///D:/Java/data/JavaSE/11-IO流/异常产生过程.png)
...
# 2. File 类用于文件和目录的操作，网络传输的文件也用它表示，见
