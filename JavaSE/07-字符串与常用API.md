...
- 什么是API
  	...
  	API 的概念贯穿整个 Java 学习，[[JavaSE/09-常用API/09-Math与System]] 涵盖了更多常用类。 ：应用程序编程接口
...
![](file:///D:/Java/data/JavaSE/07-字符串与常用API/01.png)

- 找到索引选项卡中的输入框

![](file:///D:/Java/data/JavaSE/07-字符串与常用API/02.png)

- 在输入框中输入Random

![](file:///D:/Java/data/JavaSE/07-字符串与常用API/03.png)

- 看类在哪个包下

![](file:///D:/Java/data/JavaSE/07-字符串与常用API/04.png)

- 看类的描述

![](file:///D:/Java/data/JavaSE/07-字符串与常用API/05.png)

- 看构造方法

![](file:///D:/Java/data/JavaSE/07-字符串与常用API/06.png)

- 看成员方法

![](file:///D:/Java/data/JavaSE/07-字符串与常用API/07.png)
...
> 📎 **相关笔记**：[[03-数组与方法]] · [[JavaSE/09-常用API/09-Math与System]] · [[10-集合框架]]
