...
![](file:///D:/Java/data/MySQL/进阶篇/image5.png)

DML操作遵循ACID模型，支持事务；

![](file:///D:/Java/data/MySQL/进阶篇/image6.png)

行级锁，提高并发访问性能；

![](file:///D:/Java/data/MySQL/进阶篇/image7.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image12.png)

表空间  : InnoDB存储引擎逻辑结构的最高层， ibd文件其实就是表空间文件，在表空间中可以包含多个Segment段。

![](file:///D:/Java/data/MySQL/进阶篇/image13.png)

段  : 表空间是由各个段组成的，   常见的段有数据段、索引段、回滚段等。  InnoDB中对于段的管理，都是引擎自身完成，不需要人为对其控制， 一个段中包含多个区。

![](file:///D:/Java/data/MySQL/进阶篇/image14.png)

区  : 区是表空间的单元结构，每个区的大小为1M。  默认情况下，   InnoDB存储引擎页大小为16K，  即一个区中一共有64个连续的页。

![](file:///D:/Java/data/MySQL/进阶篇/image15.png)

页  : 页是组成区的最小单元， 页也是InnoDB 存储引擎磁盘管理的最小单元，每个页的大小默认为  16KB。为了保证页的连续性， InnoDB 存储引擎每次从磁盘申请  4-5 个区。

![](file:///D:/Java/data/MySQL/进阶篇/image16.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image30.png)

顺序插入时，会形成一个链表，查询性能大大降低。

![](file:///D:/Java/data/MySQL/进阶篇/image31.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image33.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image39.png)

5阶的B树，每一个节点最多存储4个key，对应5个指针。

![](file:///D:/Java/data/MySQL/进阶篇/image40.png)

一旦节点存储的key数量到达5，就会裂变，中间元素向上分裂。

![](file:///D:/Java/data/MySQL/进阶篇/image41.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image43.png)

绿色框框起来的部分，是索引部分，仅仅起到索引数据的作用，不存储数据。

![](file:///D:/Java/data/MySQL/进阶篇/image44.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image48.png)

所有的数据都会出现在叶子节点。

![](file:///D:/Java/data/MySQL/进阶篇/image49.png)

叶子节点形成一个单向链表。

![](file:///D:/Java/data/MySQL/进阶篇/image50.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image55.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image56.png)

如果存在主键，主键索引就是聚集索引。

·  如果不存在主键，将使用第一个唯一（UNIQUE）索引作为聚集索引。

![](file:///D:/Java/data/MySQL/进阶篇/image57.png)

如果表没有主键，或没有合适的唯一索引，则InnoDB会自动生成一个rowid作为隐藏的聚集索引。

聚集索引和二级索引的具体结构如下：

![](file:///D:/Java/data/MySQL/进阶篇/image59.png)

聚集索引的叶子节点下挂的是这一行的数据  。

![](file:///D:/Java/data/MySQL/进阶篇/image60.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image94.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image151.png)

满足业务需求的情况下，尽量降低主键的长度。

![](file:///D:/Java/data/MySQL/进阶篇/image152.png)

插入数据时，尽量选择顺序插入，选择使用AUTO_INCREMENT自增主键。

![](file:///D:/Java/data/MySQL/进阶篇/image153.png)

尽量不要使用UUID做主键或者是其他自然主键，如身份证号。

![](file:///D:/Java/data/MySQL/进阶篇/image154.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image174.png)

MyISAM 引擎把一个表的总行数存在了磁盘上，因此执行  count(*) 的时候会直接返回这个数，效率很高；  但是如果是带条件的count，MyISAM也慢。

![](file:///D:/Java/data/MySQL/进阶篇/image175.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image177.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image183.png)

封装，复用  -----------------------> 可以把某一业务SQL封装在存储过程中，需要用到的时候直接调用即可。

![](file:///D:/Java/data/MySQL/进阶篇/image184.png)

可以接收参数，也可以返回数据  --------> 再存储过程中，可以传递参数，也可以接收返回值。

![](file:///D:/Java/data/MySQL/进阶篇/image185.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image188.png)

score >= 85分，等级为优秀。

![](file:///D:/Java/data/MySQL/进阶篇/image189.png)

score >= 60分  且  score < 85分，等级为及格。

![](file:///D:/Java/data/MySQL/进阶篇/image190.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image197.png)

1-3月份，为第一季度

![](file:///D:/Java/data/MySQL/进阶篇/image198.png)

4-6月份，为第二季度

![](file:///D:/Java/data/MySQL/进阶篇/image199.png)

7-9月份，为第三季度

![](file:///D:/Java/data/MySQL/进阶篇/image200.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image202.png)

LEAVE ：配合循环使用，退出循环。

![](file:///D:/Java/data/MySQL/进阶篇/image203.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image206.png)

DETERMINISTIC：相同的输入参数总是产生相同的结果

![](file:///D:/Java/data/MySQL/进阶篇/image207.png)

NO SQL ：不包含  SQL 语句。

![](file:///D:/Java/data/MySQL/进阶篇/image208.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image210.png)

全局锁：锁定数据库中的所有表。

![](file:///D:/Java/data/MySQL/进阶篇/image211.png)

表级锁：每次操作锁住整张表。

![](file:///D:/Java/data/MySQL/进阶篇/image212.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image214.png)

在进行数据备份时，先备份了tb_stock库存表。

![](file:///D:/Java/data/MySQL/进阶篇/image215.png)

然后接下来，在业务系统中，执行了下单操作，扣减库存，生成订单（更新tb_stock表，插入tb_order表）。

![](file:///D:/Java/data/MySQL/进阶篇/image216.png)

然后再执行备份  tb_order表的逻辑。

![](file:///D:/Java/data/MySQL/进阶篇/image217.png)

业务中执行插入订单日志操作。

![](file:///D:/Java/data/MySQL/进阶篇/image218.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image220.png)

如果在主库上备份，那么在备份期间都不能执行更新，业务基本上就得停摆。

![](file:///D:/Java/data/MySQL/进阶篇/image221.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image222.png)

表锁

![](file:///D:/Java/data/MySQL/进阶篇/image223.png)

元数据锁（meta data lock，MDL）

![](file:///D:/Java/data/MySQL/进阶篇/image224.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image225.png)

表独占写锁（write lock）

语法：

![](file:///D:/Java/data/MySQL/进阶篇/image226.png)

加锁： lock tables 表名 ... read/write。

![](file:///D:/Java/data/MySQL/进阶篇/image227.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image240.png)

意向共享锁 (IS): 由语句select ... lock in share mode添加  。  与  表锁共享锁(read)兼容，与表锁排他锁(write)互斥。

![](file:///D:/Java/data/MySQL/进阶篇/image241.png)

![](file:///D:/Java/data/MySQL/进阶篇/image242.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image247.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image249.png)

共享锁（ S）：允许一个事务去读一行，阻止其他事务获得相同数据集的排它锁。

![](file:///D:/Java/data/MySQL/进阶篇/image250.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image252.png)

针对唯一索引进行检索时，对已存在的记录进行等值匹配时，将会自动优化为行锁。

![](file:///D:/Java/data/MySQL/进阶篇/image253.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image261.png)

索引上的等值查询 (唯一索引)，给不存在的记录加锁时 , 优化为间隙锁  。

![](file:///D:/Java/data/MySQL/进阶篇/image262.png)

索引上的等值查询 (非唯一普通索引)，向右遍历时最后一个值不满足查询需求时， next-key lock 退化为间隙锁。

![](file:///D:/Java/data/MySQL/进阶篇/image263.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image270.png)

Trx_id：每次对某条记录进行改动时，都会把对应的事务id赋值给trx_id隐藏列。

![](file:///D:/Java/data/MySQL/进阶篇/image271.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image309.png)

READ COMMITTED ：在事务中每一次执行快照读时生成ReadView。

![](file:///D:/Java/data/MySQL/进阶篇/image310.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image317.png)
...
![](file:///D:/Java/data/MySQL/进阶篇/image333.png)

删除表的语句

![](file:///D:/Java/data/MySQL/进阶篇/image334.png)

创建表的语句

![](file:///D:/Java/data/MySQL/进阶篇/image335.png)
...
> 📎 **相关笔记**：[[MySQL-基础篇]] · [[MySQL-运维篇]] · [[MySQL 索引]] · [[JavaWeb/02-数据库与持久层|JavaWeb 数据库与持久层]]